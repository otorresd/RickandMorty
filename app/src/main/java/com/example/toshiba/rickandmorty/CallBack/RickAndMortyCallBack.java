...
import com.example.toshiba.rickandmorty.Class.Character;
...
public class RickAndMortyCallBack implements Callback<Download> {
    ...
    public List<Character> start(){
        ...
        return download == null? new ArrayList<Character>():download.getCharacters();
    }

    public List<Character> start(int page){
        RickAndMortyAPI rickAndMortyAPI = retrofit.create(RickAndMortyAPI.class);
